...
#define CONFIGURE_ARGS " '--prefix=/home/csci550user/postgresql-16.4' '--enable-debug' 'CFLAGS=-O0'"
...
#define PG_VERSION_STR "PostgreSQL 16.4 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0, 64-bit"
